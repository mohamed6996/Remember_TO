...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri == null) {
            ...
            noteFilter = NotesContract.NOTE_ID + "=" + uri.getLastPathSegment();

            Cursor cursor = getContentResolver().query(uri,
                    NotesContract.ALL_COLUMNS, noteFilter, null, null);
            cursor.moveToFirst();
            oldText = cursor.getString(cursor.getColumnIndex(NotesContract.NOTE_TEXT));
    ...
    private void updateNote(String noteText) {
        ...
        values.put(NotesContract.NOTE_TEXT, noteText);
